...
public class ChooseFunctionPage {
   ...
   Button taskmgmt = new Button();
    ...
    Button employeemgmt = new Button();
    employeemgmt.setText("Mitarbeiter- Verwaltung");
    employeemgmt.setFont(Font.font("Inter",FontWeight.SEMI_BOLD, 22));
    employeemgmt.setStyle("-fx-text-fill: #52321D; " +
                    "-fx-stroke: #52321D;" +
                    " -fx-stroke-width: 2;" +
                     "-fx-background-color: #CBAB96;" +
                    "-fx-text-alignment: center");
    employeemgmt.setPrefHeight(screenHeight * 0.4);
    employeemgmt.setPrefWidth(screenWidth * 0.17);
    employeemgmt.setWrapText(true);
